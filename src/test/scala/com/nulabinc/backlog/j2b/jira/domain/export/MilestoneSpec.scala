...
class MilestoneSpec extends Specification {
  ...
  "Milestone.apply" >> {
    val text1 = "com.atlassian.greenhopper.service.sprint.Sprint@7e5681e5[id=10,rapidViewId=2,state=FUTURE,name=goalがないスプリント,goal=,startDate=<null>,endDate=2019-04-13T15:50:00.000Z,completeDate=<null>,sequence=10]"
    ...
    // BLGMIGRATION-813
    val text2 = "com.atlassian.greenhopper.service.sprint.Sprint@2e5wdc1e5[rapidViewId=1,state=CLOSED,name=Sixth Sprint,startDate=2012-11-20T13:14:42.960-08:00,endDate=2012-12-03T13:14:00.000-08:00,goal=test goal,completeDate=2015-10-07T08:55:24.294-07:00,sequence=22,id=22]"

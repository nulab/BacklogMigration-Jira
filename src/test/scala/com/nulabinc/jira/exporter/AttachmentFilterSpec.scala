...
class AttachmentFilterSpec extends Specification {
  ...
  "AttachmentFilter.filteredIssue should return filtered an issue without file2.txt" >> {
    ...
    val issue = Issue(
      ...
      creator = User(Some("key"), Some("name"), "display", Some("mail")),
      createdAt =  new Date(),
      updatedAt =  new Date(),
      ...
      attachments = Seq(
        Attachment(
          id = 1,
          fileName = "file1.txt",
          author = User(Some("key1"), Some("user1"), "user1", Some("mail1")),
          createdAt = new Date(),
          size = 100,
          mimeType = "mine",
          content = "data"
        ...
        Attachment(
          id = 2,
          fileName = "file2.txt",
          author = User(Some("key2"), Some("user2"), "user2", Some("mail2")),
          createdAt = new Date(),
          size = 200,
          mimeType = "mine",
          content = "data"
        ...
        Attachment(
          id = 3,
          fileName = "file3.txt",
          author = User(Some("key3") , Some("user3"), "user3", Some("mail3")),
          createdAt = new Date(),
          size = 300,
          mimeType = "mine",
          content = "data"
    ...
    val comments = Seq(
      Comment(
        ...
        author = User(Some("aaa"), Some("aaa"), "aaa", Some("mmm")),
        createdAt = new Date()
      )
    )
